...
<?php
	...
	<!--inclusion estyle padding en form ---packmanitico -->	<form style="padding-left:45px;padding-top:10px; padding-bottom:10px;" id="<?php echo $formName; ?>" action="<?php echo JRoute::_('index.php'); ?>" onsubmit="return submitacymailingform('optin','<?php echo $formName;?>')" method="post" name="<?php echo $formName ?>">
				...
				<?php }
				 if($params->get('showterms',false)){
					...
					if(empty($termsIdContent)){
                        ...
                        // XXX: Callao chico
						$url = JRoute::_('?option=com_content&view=article&id='.$termsIdContent);
