<div id="icetabs<?php echo $module->id; ?>" class="ice-slideshow-white<?php echo $params->get('moduleclass_sfx','');?> <?php echo $class;?>-sl-white" style="height:<?php echo $moduleHeight;?>; width:<?php echo $moduleWidth;?>">
