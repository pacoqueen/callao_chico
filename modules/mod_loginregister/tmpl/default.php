...
endif; $pos=$params->get('btn_pos')?>

<?php   $usersConfig = &JComponentHelper::getParams( 'com_users' );
   if ($flags && $usersConfig->get('allowUserRegistration') && $type != 'logout' ) : 
if($pos=='upper')
{?>
<div style="margin-left:15px;" id="login-form">
   <input type="radio" onclick="xi('y')"  name="group1"  <?php $view=$params->get('view'); if($view=='0') {  echo 'checked= "checked"'; } ?>/> <?php echo JText::_('LOGIN') ?><br/>
<input type="radio" onclick="xi('n')"  name="group1" <?php  if($view=='1'){ echo 'checked= "checked"';}  ?> /><?php echo JText::_('Register'); ?><br/>
...
<div style="margin:0px; display:<?php if($flag2) {echo "block";} else {echo "none" ;}?>;" class="popup_register registration2">
 		...
 		<form action="<?php echo JRoute::_( 'index.php?option=com_users&task=registration.register' ); ?>" method="post" id="login-form" name="josForm" class="form-validate"  onsubmit="return checkform(this);" >
                    ...
                    <p id="form-login-username">
                     ...
                     <p id="form-login-username">
						...
						<span class="star">*</span></label>  <br/>
						<input style= "width:80%; " type="text" id="jform_username" name="jform[username]" size="20" value="" class="inputbox validate-username required"  />
                    </p>
                   ...
                   <p id="form-login-password">
                    ...
                    <p id="form-login-password">
						<label id="emailmsg" for="email" style="text-align:left;">
...
if($tos=='0')
// XXX: [callao chico] echo"<input name='option' type='checkbox'  $check / >&nbsp<a href='index.php?option=com_content&view=article&id=$articleid' target='$newwindow'> $title </a><br>";
echo"<input name='option1' type='checkbox'  $check / >&nbsp<a href='?option=com_content&view=article&id=$articleid' target='$newwindow'> $title </a><span class='star'>*</span><br>";
?><BR/>    <?php
 if ($params->get('enablecap') ) :
	...
	<div class="login_button">
			<input type="submit" name="Submit" class="button validate" value="<?php echo JText::_('JREGISTER') ?>" /></div>
...
{
?>
<div style="margin-top:9px;" id="login-form">
	<p class="form-login-remember">
	<label for"modlgn-remember">
    <?php echo JText::_('LOGIN') ?></label>
   <input class="inputbox" type="radio" onclick="xi('y')"  name="group1"  <?php $view=$params->get('view');if($view=='0'){ echo 'checked= "checked"';} ?>/><br/>
   <label for"modlgn-remember">
   <?php echo JText::_('Register'); ?></label>
	<input class="inputbox" type="radio" onclick="xi('n')"  name="group1" <?php if($view=='1'){ echo 'checked= "checked"';} ?> /><br/></p>
