	...
	<form action="<?php echo JRoute::_('index.php');?>" method="post" name="emailForm" id="emailForm" class="form-validate">
		...
		<div class="contact-email">
			...
			<div>
				...
				<input type="text" name="name" id="contact-formname" size="30" class="inputbox" value="<?php echo $user->name; ?>" />
			</div>
			<div>
				<label id="contact-emailmsg" for="contact-email">
					<?php echo JText::_('JGLOBAL_EMAIL');?>*
				</label>
				<input type="text" id="contact-email" name="email" size="30" value="<?php echo $user->email; ?>" class="inputbox required validate-email" maxlength="100" />
            <!-- EOcallao_chico -->
			</div>
			<div>
