...
Version :	4.xx (Right to Left version)
Date    :	19 March 2011
...
function displayForm($configData,$formData,$errorMessages,$validation_result)
{
	...
	echo '
		...
		<table width="100%" class="contentpaneopen">
		<tr>
		  <td align="right" width="20%">'.JText::_('COM_FLEXICONTACT_FROM_NAME').'</td>
		  <td align="right">
		...
		<tr>
		  <td align="right" width="20%">'.JText::_('COM_FLEXICONTACT_FROM_ADDRESS').'</td>
		  <td align="right">
	...
	if ($configData['subject'] == 'yes')
		echo '
			<tr>
			  <td align="right" width="20%">'.JText::_('COM_FLEXICONTACT_SUBJECT').'</td>
			  <td align="right">
	...
	if ($configData['magic_word'] != '')
		{
		echo "\n".'
			<tr><td align="right" width="20%">'.JText::_('COM_FLEXICONTACT_MAGIC_WORD').'</td>
			  <td align="right">
	...
	echo "\n".'<tr><td colspan="2">';
	echo '<input class="art-button" type="submit"   name="submit1" value="'.JText::_('COM_FLEXICONTACT_SEND_BUTTON').'" />';
	echo '</td></tr>';
